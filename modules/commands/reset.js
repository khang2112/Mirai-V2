...
module.exports.run = async ({event, api, args, Users }) => {
  ...
  if (args.length == 0) return api.sendMessage(`Bạn có thể dùng:\n\n${prefix}nam time => sẽ bật BOT lại theo thời gian bạn nhập\n${prefix}nam reset => khởi động lại BOT\n${prefix}nam off => tắt BOT\n${prefix}nam on => bật BOT`, event.threadID, event.messageID);
 if (args[0] == "time") {
